...
- [x] `2026-02-15` Docs TOML validation pass completed: all `docs/**/*.toml` files parse successfully, and embedded diagram/control-flow payloads in canonical definitions were normalized to multiline doc-string delimiters (`"""`) with content preserved.
