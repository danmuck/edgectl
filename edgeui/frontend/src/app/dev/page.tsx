			...
			<div className="relative">
				<div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-10">
					<header className="flex flex-wrap items-center justify-between gap-4">
						<div className="space-y-1">
							...
							<p className="text-muted-foreground text-sm">
								Use the tabs to review shadcn UI components in
								one place.
							</p>
						</div>
						<div className="flex flex-wrap items-center gap-2">
							...
							<Button
								onClick={() => toast("Theme preview toast")}
							>
								Trigger Toast
							</Button>
						</div>
					...
					<Card className="border-border/60 bg-card/70 backdrop-blur">
						<CardHeader>
							<CardTitle>
								Theme overrides (edit in this file)
							</CardTitle>
							<CardDescription>
								Update the{" "}
								<span className="font-mono">themeVars</span>{" "}
								object at the top of{" "}
								<span className="font-mono">
									app/dev/page.tsx
								</span>{" "}
								to iterate on colors and radius.
							</CardDescription>
							<CardAction>
						...
						<CardContent className="grid gap-4">
							<div className="grid gap-2 text-xs text-muted-foreground">
								<span>
									Tokens preview (primary, secondary, accent,
									muted, destructive)
								</span>
							...
							<div className="grid gap-2 text-xs">
								<div className="rounded-lg border border-dashed border-border bg-muted/40 p-3">
									Edit the values in{" "}
									<span className="font-mono">themeVars</span>{" "}
									to update this entire page without touching
									global styles.
								</div>
							</div>
						</CardContent>
										...
										<div className="flex flex-col gap-4 p-4">
											...
											<Card className="border-dashed">
												<CardHeader>
													...
													<CardDescription>
														Use this area to test
														sidebar spacing.
													</CardDescription>
												</CardHeader>
												<CardContent className="text-sm text-muted-foreground">
													The sidebar is rendered with{" "}
													<span className="font-mono">
														collapsible="none"
													</span>{" "}
													to avoid fixed positioning
													in this preview.
												</CardContent>
											</Card>
										</div>
