...
export default function DevNav() {
	...
	return (
		<header className="relative z-50 border-b border-white/10 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 text-slate-100 shadow-lg">
			{/* Main Nav container */}
			<div className="mx-auto flex w-full max-w-[1400px] flex-wrap items-center gap-4 px-6 py-4 sm:px-8">
				{/* Title card */}
				<div className="flex items-center gap-3">
					<button
						...
						className="text-xs font-semibold uppercase tracking-[0.35em] text-slate-400 transition hover:text-slate-200"
					>
						edgectl
					</button>
					<Badge
